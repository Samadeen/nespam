...
const Dashboard = () => {
  ...
  const renderStepComponent = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <DocumentUploads onProceed={handleProceed} onReturn={handleReturn} />
        );
      case 3:
        return <Services onProceed={handleProceed} onReturn={handleReturn} />;
      case 4:
        return (
          <ContactProfile onProceed={handleProceed} onReturn={handleReturn} />
        );
    }
  };
