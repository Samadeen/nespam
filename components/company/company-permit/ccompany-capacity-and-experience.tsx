...
interface CompanyCapacityAndExperienceProps {
  onProceed: () => void;
  onReturn: () => void;
}

const CompanyCapacityAndExperience = ({
  onProceed,
  onReturn,
}: CompanyCapacityAndExperienceProps) => {
...
export default CompanyCapacityAndExperience;
